...
<div class="container">
	<div class="row">
		<div class="col-12">
			    <center>
		<h2 id="paymehader" style="color: #fff;">Send Payment To:  ETH 0x9BAb91e00106df26a2E35B82738E2D76735C2F76</h2>
		<h3 style="color: white;"><b>For any questions please contact: support@cryptomarketcloud.com</b></h3>	
    </center>
							 ...
							 <div class="form-group row">
							    ...
							    <div class="col-sm-10">
							      <select name="pakage" class="select form-control-o select2-hidden-accessible" id="id_chain" tabindex="-1" aria-hidden="true" type="text"> 
				                      ...
				                      <option value="OEX Exchange Listing">OEX Exchange Listing</option>
				                      <option value="OEX Exchange Listing + Crypto Market CLoud ">OEX Exchange Listing + Crypto Market CLoud </option>
				                   </select> 
							    </div>
							 </div>
