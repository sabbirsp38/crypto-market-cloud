          ...
          <div class="container-fluid">
            <div class="container">
                 <div class="FROMCOUSTOM">
                  ...
                  <form data-provide="validation" data-disable="false" method="post" autocomplete="off" enctype="multipart/form-data" novalidate="true"  action="dbconnceticomamber p.php" >
                <div class="card">
