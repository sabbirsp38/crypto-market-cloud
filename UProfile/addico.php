          ...
          <div class="container-fluid">
            <div class="container">
                 <div class="FROMCOUSTOM">
                  ...
                  <form data-provide="validation" data-disable="false" method="post" autocomplete="off" enctype="multipart/form-data" novalidate="true"  action="dbconnceticomamber.php" >
                <div class="card">
                      ...
                      <label for="id_image" class="col-form-label text-uppercase text-fader fw-500 fs-11"> ICO Logo</label>
                         <div class=""> 
                            <div class="dropify-wrapper">
                                  <input type="file" name="image" data-provide="dropify" data-allowed-file-extensions="png jpg jpeg JPG PNG JPEG" data-allowed-formats="square" class="clearablefileinput" id="id_image">   
                            </div>   
                        </div> 
                    </div> 
                 </div>
                            ...
                            <div id="div_id_email" class="form-group"> 
                              <label  class="col-form-label text-uppercase text-fader fw-500 fs-11 require">
                               ...
                               <div class="">
                                 ...
                                 <select name="status" class="select form-control select2-hidden-accessible" id="id_country" tabindex="-1" aria-hidden="true" type="text"> 
                                    <option value="PRE-SELL" selected="">PRE-SELL</option> 
              ...
              <div class="col-md-6"> 
                ...
                <div class=""> 
                  <div class="input-group"> 
                    ...
                    <input type="date" name="pre_ico_start" class="datetimeinput form-control" id="id_pre_ico_start"> 
                  </div> 
                  <div class="invalid-feedback">
                ...
                <div class=""> 
                  <div class="input-group"> 
                    ...
                    <input type="date" name="pre_ico_end" class="datetimeinput form-control" id="id_pre_ico_end"> 
                  </div> 
                  <div class="invalid-feedback">
                ...
                <div class=""> 
                  <div class="input-group"> 
                    ...
                    <input type="date" name="ico_start" class="datetimeinput form-control" id="id_ico_start"> 
                  </div> 
                  <div class="invalid-feedback">
              ...
              <div id="div_id_ico_end" class="form-group"> 
                ...
                <div class=""> 
                  <div class="input-group"> 
                    ...
                    <input type="date" name="ico_end" class="datetimeinput form-control" id="id_ico_end"> 
                  </div> 
                  <div class="invalid-feedback">
                ...
                </label> <div class=""> <div class="input-group"> <div class="input-group-prepend">  </div> <input type="url" name="ico_links-0-youtube" maxlength="200" class="urlinput form-control" id="id_ico_links-0-youtube"> </div> <div class="invalid-feedback"></div> </div> </div> </div>


<div class="col-md-6 col-lg-4"> <div id="div_id_ico_links-0-youtube" class="form-group"> <label for="id_ico_links-0-youtube" class="col-form-label text-uppercase text-fader fw-500 fs-11">
                Whitepaper
                </label> <div class=""> <div class="input-group"> <div class="input-group-prepend">  </div> <input type="url" name="ico_whitepaper_new" maxlength="200" class="urlinput form-control" id="id_ico_links-0-youtube"> </div> <div class="invalid-feedback"></div> </div> </div> </div></div></div></div>
