          ...
          <div class="container-fluid">
            <div class="container">
                 <div class="FROMCOUSTOM">
                    <h1 id="FROMCOUSTOM" style="color: white;">Edit Your ICO</h1>
                  </div>

                  <!-- From Start Here-->

                  <form data-provide="validation" data-disable="false" method="post" autocomplete="off" enctype="multipart/form-data" novalidate="true"  action="dbconncet editepost.php? $id=<?php echo $result['id']; ?>" >
                <div class="card">
                    ...
                    <div class="row"> 
                        <div class="col-12"> 
                          <div id="div_id_title" class="form-group"> 
                            ...
                            <div class=""> 
                              <input type="text" name="title" maxlength="256" class="textinput textInput form-control" required="" id="id_title" value="<?php echo $result['name']; ?>"> 
                      ...
                      <label for="id_image" class="col-form-label text-uppercase text-fader fw-500 fs-11"> ICO Logo</label>
                         <div class=""> 
                            <div class="dropify-wrapper">
                                  <input type="file" name="image" data-provide="dropify" data-allowed-file-extensions="png jpg jpeg JPG PNG JPEG" data-allowed-formats="square" class="clearablefileinput" id="id_image" value="<?php echo $result['image']; ?>">   
                            </div>   
                        </div> 
                    </div> 
                 </div>
                              ...
                              <label for="id_email" class="col-form-label text-uppercase text-fader fw-500 fs-11 require">
                               ...
                               <div class="">
                                ...
                                <div class="input-group"> 
                                    ...
                                    <input type="text" name="email" maxlength="254" class="emailinput form-control" required="" id="id_email" value="<?php echo $result['email']; ?>"> 
                                  </div> 
                              ...
                              <label  class="col-form-label text-uppercase text-fader fw-500 fs-11 require">
                               ...
                               <div class="">
                                ...
                                <div class="input-group"> 
                                    ...
                                    <input type="text" name="status"  class="t form-control"  id="id_email"  value="<?php echo $result['stutas']; ?>"> 
                                  </div> 
                ...
                <div class="col-4"> 
                  <div id="div_id_country" class="form-group"> 
                    <label for="id_country" class="col-form-label text-uppercase text-fader fw-500 fs-11"> Please select funding method
                     </label>
                       <div class=""> 
                          <select name="ico_type" class="select form-control select2-hidden-accessible" id="id_country" tabindex="-1" aria-hidden="true" type="text" > 
                            <option value="<?php echo $result['ico_type']; ?>" selected=""><?php echo $result['ico_type']; ?></option>
              ...
              <div class="col-md-6"> 
                <div id="div_id_chain" class="form-group"> 
                  ...
                  <div class=""> 
                    <select name="chain" class="select form-control select2-hidden-accessible" id="id_chain" tabindex="-1" aria-hidden="true" type="text"> 
                      <option value="<?php echo $result['chain']; ?>" selected=""><?php echo $result['chain']; ?></option> 
                ...
                <div class="col-md-6"> 
                  <div id="div_id_symbol" class="form-group"> 
                    ...
                    <div class=""> 
                       <input value="<?php echo $result['symbol']; ?>" type="text" name="symbol" maxlength="30" class="textinput textInput form-control" id="id_symbol" > <div class="invalid-feedback">
                ...
                <div class="col-md-6"> 
                  <div id="div_id_address" class="form-group"> 
                    ...
                    <div class=""> 
                      <input type="text" value="<?php echo $result['address']; ?>" name="address" maxlength="180" class="textinput textInput form-control" id="id_address"> 
                      <div class="invalid-feedback">
                ...
                <div class=""> 
                  <div class="input-group"> 
                    ...
                    <input type="text" name="pre_ico_start" class="datetimeinput form-control" id="id_pre_ico_start" value="<?php echo $result['pre_ico_start']; ?>"> 
                  </div> 
                  <div class="invalid-feedback">
                ...
                <div class=""> 
                  <div class="input-group"> 
                    ...
                    <input type="text" name="pre_ico_end" class="datetimeinput form-control" id="id_pre_ico_end" value="<?php echo $result['pre_ico_end']; ?>"> 
                  </div> 
                  <div class="invalid-feedback">
                ...
                <div class=""> 
                  <div class="input-group"> 
                    ...
                    <input type="text" value="<?php echo $result['ico_start']; ?>" name="ico_start" class="datetimeinput form-control" id="id_ico_start"> 
                  </div> 
                  <div class="invalid-feedback">
              ...
              <div id="div_id_ico_end" class="form-group"> 
                ...
                <div class=""> 
                  <div class="input-group"> 
                    ...
                    <input type="text" name="ico_end" class="datetimeinput form-control" id="id_ico_end" value="<?php echo $result['ico_end']; ?>"> 
                  </div> 
                  <div class="invalid-feedback">
                ...
                <div class=""> 
                  <textarea name="description" cols="40" rows="10" maxlength="32000" class="textarea form-control" required="" id="id_description" value="" ><?php echo $result['description']; ?></textarea> 
                  <div class="invalid-feedback" >
                ...
                Website
                </label> <div class=""> <div class="input-group"> <div class="input-group-prepend">  </div> <input type="url" name="ico_links-0-website" maxlength="200" class="urlinput form-control" id="id_ico_links-0-website" value="<?php echo $result['ico_links_website']; ?>"> </div> <div class="invalid-feedback"></div> </div> </div> </div>
                ...
                Instagram
                </label> <div class=""> <div class="input-group"> <div class="input-group-prepend">  </div> <input type="url" name="ico_links-0-whitepaper" maxlength="200" class="urlinput form-control" id="id_ico_links-0-whitepaper" value="<?php echo $result['ico_links_whitepaper']; ?>"> </div> <div class="invalid-feedback" ></div> </div> </div> </div>
                <div class="col-md-4 col-lg-4 col-sm-6"> <div id="div_id_ico_links-0-whitepaper" class="form-group"> <label for="id_ico_links-0-whitepaper" class="col-form-label text-uppercase text-fader fw-500 fs-11">
                Telegram
                </label> <div class=""> <div class="input-group"> <div class="input-group-prepend">  </div> 
                <input type="url" name="ico_real_links_telegram" maxlength="200" class="urlinput form-control" id="id_ico_links-0-Telegram" value="<?php echo $result['ico_real_links_telegram']; ?>"> </div> <div class="invalid-feedback"></div> </div> </div> </div>
                ...
                Medium
                </label> <div class=""> <div class="input-group"> <div class="input-group-prepend">  </div> <input type="url" name="ico_links-0-telegram" maxlength="200" class="urlinput form-control" id="id_ico_links-0-telegram" value="<?php echo $result['ico_links_telegram']; ?>"> </div> <div class="invalid-feedback"></div> </div> </div> </div>
                ...
                Twitter
                </label> <div class=""> <div class="input-group"> <div class="input-group-prepend">  </div> <input type="url" name="ico_links-0-twitter" maxlength="200" class="urlinput form-control" id="id_ico_links-0-twitter" value="<?php echo $result['ico_links_twitter']; ?>"> </div> <div class="invalid-feedback" ></div> </div> </div> </div>
                ...
                </label> <div class=""> <div class="input-group"> <div class="input-group-prepend">  </div> <input type="url" name="ico_links-0-bitcointalk" maxlength="200" class="urlinput form-control" id="id_ico_links-0-bitcointalk" value="<?php echo $result['ico_links_bitcointalk']; ?>"> </div> <div class="invalid-feedback"></div> </div> </div> </div>
                ...
                Github 
                </label> <div class=""> <div class="input-group"> <div class="input-group-prepend">  </div> <input type="url"  name="ico_links-0-github" maxlength="200" class="urlinput form-control" id="id_ico_links-0-github"
                 value="<?php echo $result['ico_links_github']; ?>"> </div> <div class="invalid-feedback"></div> </div> </div> </div>
                ...
                Linkedin
                </label> <div class=""> <div class="input-group"> <div class="input-group-prepend">  </div> <input type="url" name="ico_links-0-linkedin" maxlength="200" class="urlinput form-control" id="id_ico_links-0-linkedin" value="<?php echo $result['ico_links_linkedin']; ?>"> </div> <div class="invalid-feedback"></div> </div> </div> </div>
                ...
                Facebook
                </label> <div class=""> <div class="input-group"> <div class="input-group-prepend">  </div> <input type="url" name="ico_links-0-facebook" maxlength="200" class="urlinput form-control" id="id_ico_links-0-facebook" value="<?php echo $result['ico_links_facebook']; ?>"> </div> <div class="invalid-feedback"></div> </div> </div> </div>
                ...
                </label> <div class=""> <div class="input-group"> <div class="input-group-prepend">  </div> <input type="url" name="ico_links-0-youtube" maxlength="200" class="urlinput form-control" id="id_ico_links-0-youtube"  value="<?php echo $result['ico_links_youtube']; ?>"> </div> <div class="invalid-feedback"></div> </div> </div> </div>


<div class="col-md-6 col-lg-4"> <div id="div_id_ico_links-0-youtube" class="form-group"> <label for="id_ico_links-0-youtube" class="col-form-label text-uppercase text-fader fw-500 fs-11">
                Whitepaper
                </label> <div class=""> <div class="input-group"> <div class="input-group-prepend">  </div> <input type="url" name="ico_whitepaper_new" maxlength="200" class="urlinput form-control" id="id_ico_links-0-youtube" value="<?php echo $result['ico_whitepaper_new']; ?>"> </div> <div class="invalid-feedback" ></div> </div> </div> </div></div></div></div>
               ...
               <div class="card" >
                ...
                <div class="row team-member-row mb-2"> <div class="col-md-4"> <div class="form-group" id="div_id_ico_members-0-image"> <label class="col-form-label text-uppercase text-fader fw-500 fs-11" for="id_ico_members-0-image">Image</label> <div> <div class="dropify-wrapper">
                <input name="ico_members-0-image" value="<?php echo $result['ico_members_image']; ?>" class="member_image clearablefileinput" id="id_ico_members-0-image" type="file" data-allowed-formats="square" data-allowed-file-extensions="png jpg jpeg">
                ...
                <input name="ico_members-0-name" class="textinput textInput form-control" id="id_ico_members-0-name" type="text" maxlength="1000" value="<?php echo $result['ico_members_name']; ?>"> <div class="invalid-feedback"></div> </div> </div> </div>
                ...
                Role
                </label> <div> <input name="ico_members-0-role" class="textinput textInput form-control" id="id_ico_members-0-role" type="text" maxlength="1000" value="<?php echo $result['ico_members_role']; ?>"> <div class="invalid-feedback"></div> </div> </div> </div>
                ...
                <input name="ico_members-0-linkedin_url" class="urlinput form-control" id="id_ico_members-0-linkedin_url" type="url" maxlength="200" value="<?php echo $result['ico_members_linkedin_url']; ?>"> </div> <div class="invalid-feedback" ></div> </div> </div> </div>
                ...
                <input name="ico_members-0-twitter_url" class="urlinput form-control" id="id_ico_members-0-twitter_url" type="url" maxlength="200" value="<?php echo $result['ico_members_twitter_url']; ?>"> </div> <div class="invalid-feedback" ></div> </div> </div> </div>
                ...
                <div class="row team-member-row mb-2"> <div class="col-md-4"> <div class="form-group" id="div_id_ico_members-1-image"> <label class="col-form-label text-uppercase text-fader fw-500 fs-11" for="id_ico_members-1-image">
                Image
                </label> <div> <div class="dropify-wrapper"><div class="dropify-errors-container"><ul></ul></div><input name="ico_members_tow_image" class="member_image clearablefileinput" id="id_ico_members-1-image" type="file" data-allowed-formats="square" data-allowed-file-extensions="png jpg jpeg"  value="<?php echo $result['ico_members_tow_image']; ?>"></div> <div class="invalid-feedback"></div> </div> </div> </div>
                ...
                Name
                </label> <div> <input name="ico_members_tow_name" class="textinput textInput form-control" id="id_ico_members-1-name" type="text" maxlength="1000" value="<?php echo $result['ico_members_tow_name']; ?>"> <div class="invalid-feedback"></div> </div> </div> </div>
                ...
                Role
                </label> <div> <input name="ico_members_tow_role" class="textinput textInput form-control" id="id_ico_members-1-role" type="text" maxlength="1000" value="<?php echo $result['ico_members_tow_role']; ?>"> <div class="invalid-feedback"></div> </div> </div> </div>
                ...
                Linkedin url
                </label> <div> <div class="input-group"> <div class="input-group-prepend"> </div> <input name="ico_members_tow_linkedin_url" class="urlinput form-control" id="id_ico_members-1-linkedin_url" type="url" maxlength="200" value="<?php echo $result['ico_members_tow_linkedin_url']; ?>"> </div> <div class="invalid-feedback"></div> </div> </div> </div>
                ...
                Twitter url
                </label> <div> <div class="input-group"> <div class="input-group-prepend"> </div> <input name="ico_members_tow_twitter_url" class="urlinput form-control" id="id_ico_members-1-twitter_url" type="url" maxlength="200" value="<?php echo $result['ico_members_tow_twitter_url']; ?>"> </div> <div class="invalid-feedback"></div> </div> </div> </div>
                ...
                <div class="row team-member-row mb-2"> <div class="col-md-4"> <div class="form-group" id="div_id_ico_members-2-image"> <label class="col-form-label text-uppercase text-fader fw-500 fs-11" for="id_ico_members-2-image">
                Image</label> <div> <div class="dropify-wrapper">

                  <input name="ico_members_three_image" class="member_image clearablefileinput" id="id_ico_members-2-image" type="file" data-allowed-formats="square" data-allowed-file-extensions="png jpg jpeg" value="<?php echo $result['ico_members_three_image']; ?>"></div> <div class="invalid-feedback"></div> </div> </div> </div>
                ...
                Name
                </label> <div> <input name="ico_members_three_name" class="textinput textInput form-control" id="id_ico_members-2-name" type="text" maxlength="1000" value="<?php echo $result['ico_members_three_name']; ?>"> <div class="invalid-feedback"></div> </div> </div> </div>
                ...
                Role
                </label> <div> <input name="ico_members_three_role" class="textinput textInput form-control" id="id_ico_members-2-role" type="text" maxlength="1000" value="<?php echo $result['ico_members_three_role']; ?>"> <div class="invalid-feedback"></div> </div> </div> </div>
                ...
                Linkedin url
                </label> <div> <div class="input-group"> <div class="input-group-prepend">  </div> <input name="ico_members_three_linkedin_url" class="urlinput form-control" id="id_ico_members-2-linkedin_url" type="url" maxlength="200" value="<?php echo $result['ico_members_three_linkedin_url']; ?>"> </div> <div class="invalid-feedback"></div> </div> </div> </div>
                ...
                Twitter url
                </label> <div> <div class="input-group"> <div class="input-group-prepend">  </div> <input name="ico_members_three_twitter_url" class="urlinput form-control" id="id_ico_members-2-twitter_url" type="url" maxlength="200" value="<?php echo $result['ico_members_three_twitter_url']; ?>"> </div> <div class="invalid-feedback"></div> </div> </div> </div>
    ...
    <!-- end team section  -->
              ...
              <div class="card-body">
              <div class="row milestone-row mb-2"> <div class="col-12"> <div class="form-group" id="div_id_milestones-0-name"> <label class="col-form-label text-uppercase text-fader fw-500 fs-11 require" for="id_milestones-0-name">
              Milestone title
              </label> <div> <input name="milestones_first_name" class="textinput textInput form-control" id="id_milestones-0-name" type="text" maxlength="256"value="<?php echo $result['milestones_first_name']; ?>"> <div class="invalid-feedback"></div> </div> </div> </div>
              ...
              </label> <div> <textarea name="milestones_first_description" class="textarea form-control" id="id_milestones-0-description" maxlength="8192" rows="4" cols="40"><?php echo $result['milestones_first_description']; ?></textarea> <div class="invalid-feedback"></div> </div> </div> </div>
              ...
              Milestone title
              </label> <div> <input name="milestones_tow_name" class="textinput textInput form-control" id="id_milestones-1-name" type="text" maxlength="256"value="<?php echo $result['milestones_tow_name']; ?>"> <div class="invalid-feedback"></div> </div> </div> </div>
              ...
              Milestone description
              </label> <div> <textarea name="milestones_tow_description" class="textarea form-control" id="id_milestones-1-description" maxlength="8192" rows="4" cols="40"><?php echo $result['milestones_tow_description']; ?></textarea> <div class="invalid-feedback"></div> </div> </div> </div>
              ...
              Milestone title
              </label> <div> <input name="milestones_three_name" class="textinput textInput form-control" id="id_milestones-2-name" type="text" maxlength="256" value="<?php echo $result['milestones_three_name']; ?>"> <div class="invalid-feedback"></div> </div> </div> </div>
              ...
              Milestone description
              </label> <div> <textarea name="milestones_three_description" class="textarea form-control" id="id_milestones-2-description" maxlength="8192" rows="4" cols="40"><?php echo $result['milestones_three_description']; ?></textarea> <div class="invalid-feedback"></div> </div> </div> </div>
            ...
            <!-- End Read Map -->
                ...
                <div class="card-body">
                <div class="row"> <div class="col-md-6"> <div id="div_id_icofinance-0-token_supply" class="form-group"> <label for="id_icofinance-0-token_supply" class="col-form-label text-uppercase text-fader fw-500 fs-11">
                Total token supply
                </label> <div class=""> 

                  <input type="number" name="icofinance-0-token_supply" min="-9223372036854775808" max="9223372036854775807" class="numberinput form-control" id="id_icofinance-0-token_supply"  value="<?php echo $result['icofinance_token_supply']; ?>"> <div class="invalid-feedback">
                ...
                <div class=""> 
                  <input type="number" name="icofinance-0-token_for_sale" min="-9223372036854775808" max="9223372036854775807" class="numberinput form-control" id="id_icofinance-0-token_for_sale" value="<?php echo $result['icofinance_token_for_sale']; ?>"> <div class="invalid-feedback"></div> 
                ...
                SOFT CAP
                  ...
                  <input type="number" name="icofinance-0-token_total_soft_cap" min="-9223372036854775808" max="9223372036854775807" class="numberinput form-control" id="id_icofinance-0-token_total_soft_cap" value="<?php echo $result['icofinance_token_total_soft_cap']; ?>"> <div class="invalid-feedback"></div> <small id="hint_id_icofinance-0-token_total_soft_cap" class="form-text text-muted">Minimum amount of funds aimed to gather in the ICO</small> 
                </div> 
              </div> 
            </div>
                ...
                SOFT CAP currency
                   ...
                   <input type="text" name="icofinance-0-token_total_soft_cap_currency"  class="numberinput form-control" id="icofinance-0-token_total_soft_cap_currency" value="<?php echo $result['icofinance_token_total_soft_cap_currency']; ?>">
                ...
                <div class=""> 
                  ...
                  <input type="number" name="icofinance-0-token_total_hard_cap" min="-9223372036854775808" max="9223372036854775807" class="numberinput form-control" id="id_icofinance-0-token_total_hard_cap" value="<?php echo $result['icofinance_token_total_hard_cap']; ?>"> 
                ...
                <input type="text" name="icofinance-0-token_total_hard_cap_currency"  class="numberinput form-control" id="icofinance-0-token_total_hard_cap_currency" value="<?php echo $result['icofinance_token_total_hard_cap_currency']; ?>">
                ...
                Token price
                  ...
                  <input type="number" name="icofinance-0-token_price" step="1e-8" class="numberinput form-control" id="id_icofinance-0-token_price" value="<?php echo $result['icofinance_token_price']; ?>"> <div class="invalid-feedback"></div> <small id="hint_id_icofinance-0-token_price" class="form-text text-muted">Price of one token (without any bonus)</small> 
              </div> 
            </div> 
          </div>
                <div class="col-6 col-md-3"> 
                ...
                CURRENCY ACCEPTED
                  ...
                  <input type="text" name="icofinance-0-token_price_currency"  class="numberinput form-control" id="icofinance-0-token_price_currency" value="<?php echo $result['icofinance_token_price_currency']; ?>">
                  <div class="invalid-feedback">
                ...
                Whitelist required
                  ...
                  <select name="icofinance-0-is_whitelist_required" class="nullbooleanselect form-control" id="id_icofinance-0-is_whitelist_required" type="text"> 
                          <option value="<?php echo $result['icofinance_is_whitelist_required']; ?>" selected=""><?php echo $result['icofinance_is_whitelist_required']; ?></option> 
                ...
                KYC required
                  ...
                  <select name="icofinance-0-is_kyc_required" class="nullbooleanselect form-control" id="id_icofinance-0-is_kyc_required"> 
                ...
                <input type="text" name="icofinance-0-accepted_currencies"  class="numberinput form-control" id="icofinance-0-accepted_currencies" value="<?php echo $result['icofinance_accepted_currencies']; ?>">
                ...
                <input type="text" name="icofinance-0-restricted_countries"  class="numberinput form-control" id="icofinance-0-restricted_countries" value="<?php echo $result['icofinance_restricted_countries']; ?>"> 
                ...
                Token sale bonus
                </label> <div class=""> <textarea name="icofinance-0-bonus" cols="40" rows="10" maxlength="1024" class="textarea form-control" id="id_icofinance-0-bonus" value="<?php echo $result['icofinance_bonus']; ?>"><?php echo $result['icofinance_bonus']; ?></textarea> <div class="invalid-feedback"></div> </div> </div> </div>
                </div> 
                </div>
                </div>
                ...
                <div class="card-body">
                <div class="row"> <div class="col-md-6 bounty-date"> <div id="div_id_bounty-0-start" class="form-group"> <label for="id_bounty-0-start" class="col-form-label text-uppercase text-fader fw-500 fs-11">
                Bounty campaign start
                </label> <div class=""> <div class="input-group"> <div class="input-group-prepend">  </div> <input type="text" name="bounty-0-start" class="dateinput form-control" id="id_bounty-0-start" value="<?php echo $result['bounty_start']; ?>"> </div> <div class="invalid-feedback"></div> </div> </div> </div>
                ...
                Bounty campaign end
                </label> <div class=""> <div class="input-group"> <div class="input-group-prepend">  </div> <input type="text" name="bounty-0-end" class="dateinput form-control" id="id_bounty-0-end" value="<?php echo $result['bounty_end']; ?>"> </div> <div class="invalid-feedback"></div> </div> </div> </div>
                ...
                Bounty types
                          ...
                          <option value="<?php echo $result['bounty_types']; ?>" selected=""><?php echo $result['bounty_types']; ?></option> 
                ...
                Tokens for bounty
                </label> <div class=""> <input value="<?php echo $result['bounty_total_tokens']; ?>" type="number" name="bounty-0-total_tokens" min="-9223372036854775808" max="9223372036854775807" class="numberinput form-control" id="id_bounty-0-total_tokens"> <div class="invalid-feedback"></div> </div> </div> </div>
                ...
                Additional comments
                </label> <div class=""> <textarea name="review_note" cols="40" rows="5" class="textarea form-control" id="id_review_note"><?php echo $result['review_note']; ?></textarea> <div class="invalid-feedback"></div> <small id="hint_id_review_note" class="form-text text-muted">Any additional comments and notes for reviewer.</small> 
              </div> 
            </div> 
          </div>
                <div class="col-12"> <input type="submit" name="save" value="Submit ICO" class="btn btn-primary btn btn-bold btn-round btn-w-xl btn-primary float-right" id="submit-id-save" style="background-color: transparent; color: black;">
                </div>
                </div>
                </div>
                </div>
