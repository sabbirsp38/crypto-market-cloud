...
<html lang="en">
  <head>
   ...
   <title>crypto market cloud live prices bitcoin</title>
...
<div class="Brack1"></div>
	...
	<center><h1 class="cryptodir">Crypto Directory</h1></center>
	<div class="row">
      ...
      <?php
      $query = "select * from tbl_directory order by id desc limit $start_from, $per_page";
...
<div class="paginetationFull clear">
    <!--paginetation-->
    <?php
    $query = "select * from tbl_directory"; 
    $result = $db->select($query);
    $total_rows = mysqli_num_rows($result);
    $total_page = ceil ($total_rows/$per_page);

    echo " <span class=paginetation > <a href='DirectoryList.php?page=1 '>First Page</a>";

    for ($i=1; $i<= $total_page; $i++) { 
     echo "<a href='DirectoryList.php?page=".$i." '>".$i. "</a>";
     } 


     echo "<a href='DirectoryList.php?page=$total_page '>Last Page</a></span>"?>
