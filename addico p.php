...
<div class="col-md-6 col-lg-4"> <div id="div_id_ico_links-0-youtube" class="form-group"> <label for="id_ico_links-0-youtube" class="col-form-label text-uppercase text-fader fw-500 fs-11">
    ...
    <!-- end team section  -->
            ...
            <!-- End Read Map -->
                ...
                <div class="col-12"> <input type="submit" name="save" value="Submit ICO" class="btn btn-primary btn btn-bold btn-round btn-w-xl btn-primary float-right" id="submit-id-save" style="background-color: transparent;">
                </div>
                </div>
                </div>
                </div>
