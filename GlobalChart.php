...
<style>
   ...
   <!--AD Space-->
      ...
      <div class="container-fluid " style="background:white">
        <div class="container MyCoustomNavHader">
            ...
            <div data-global-currency-switch="" class="btn-group global-currency-dropdown-container" style="visibility:hidden">
                <button type="button" class="btn btn-default btn-md dropdown-toggle global-currency-dropdown BTNCOUSTOM" data-toggle="dropdown" id="hideMe">
                <span data-currency-display="" id="display" >USD</span> <span class="caret"></span>
                </button>
                <ul class="dropdown-menu currency_list" role="menu" >
      ...
      <div class="container-fluid ">
        <div class="container NavCoustom">
            <div class="navbar-header">
              <a class="navbar-brand" href="index"><img class="img CoustomLogoIMGindex  " src="images/logo.png"></a>
            </div>
            <ul class="nav navbar-nav ">
              <li><a href="index" style="color: white;">Rankings </a>
                <ul class="currency_sort">
                  <li><a  href="index">Top 100 Coins</a></li>
                  <li><a href="index">Top 100 Tokens</a></li>
                </ul>
              </li>
                <li><a style="color: white;" href="Calculator">Tools</a>
                  <ul>
                      <li><a href="Calculator">Converter </a></li>
                      <li><a href="GlobalChart">Global Chart </a></li>
                  </ul>
                </li>
                <li><a style="color: white;" href="Advertisement">Services</a>
                  <ul>
                ...
                <li><a style="color: white;" href="login">Member</a>
                  <ul>
                  <li><a href="login">Log In</a></li>
                  <li><a href="login">Chat Room</a></li>
                </ul>
                </li>
                <li><a style="color: white;" href="Member">ICO</a>
                  <ul>
                  <li><a href="Member">ICO List</a></li>
                  <li><a href="addico">Add New ICO</a></li>
                </ul>

                </li>

                <li><a style="color: white;" href="postlist">News Blast</a></li>
                <li><a style="color: white;" href="#">More</a>
                  <ul>
                  <li><a href="disclamier">About US</a></li>
                  ...
                  <div class="navbar-right CoustomScerchButton ">
                  
                    <form class="navbar-form  " action="/action_page.php">
              <div class="input-group">
                <input type="text" class="form-control" placeholder="Search">
                <div class="input-group-btn">
                  <button class="btn btn-default CoustomButton" type="submit">
  ...
  <!--- End Navigation ---->
    ...
    <div style="margin-top: -70px;" class="AddSpace">
    ...
    <div class="container CorsollArea" >
       <div class="row">
                 ...
                 <div class="col-lg-2 col-md-2 col-sm-2 "  ">
                    <a href="https://nexo.io/" target="_blank">
                       <div class="hovereffect">
                            <img class="img-responsive" src="images/add1.jpg" alt="">
                            <div class="overlay">
                               <p>NEXO-Get an Instant Crypto-backed Loan up to 2M</p>
                               <a class="info" href="https://nexo.io/">visit website</a>
                            </div>
                        </div>
                        </a>
                    </div>
          ...
          <div class="col-lg-2 col-md-2 col-sm-2 "  ">
                    <a href="http://bitstation.co/" target="_blank">
                       <div class="hovereffect">
                            <img class="img-responsive" src="images/add2.jpg" alt="">
                            <div class="overlay">
                               <p>Bitstation The most advanced AL trading</p>
                               <a class="info" href="http://bitstation.co/">visit website</a>
                            </div>
                        </div>
                        </a>
                    </div>
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-2 "  ">
                    <a href="https://urunit.io/" target="_blank">
                       <div class="hovereffect">
                            <img class="img-responsive" src="images/add3.jpg" alt="">
                            <div class="overlay">
                               <p> U Run it. New era in gambling industry</p>
                               <a class="info" href="https://urunit.io/">visit website</a>
                            </div>
                        </div>
                        </a>
                    </div>
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-2 "  ">
                    <a href="http://smtecbd.com/" target="_blank">
                       <div class="hovereffect">
