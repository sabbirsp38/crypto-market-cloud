...
<svg viewBox="0 0 960 300">
	<symbol id="s-text">
		<text text-anchor="middle" x="50%" y="80%">Congratulations</text>
	</symbol>
...
<span style="font-size:24px;">Now You Are a Investor of CryptoMarketCloud</span>
</center>
...
<script>
setTimeout(function () {
   window.location.href= 'https://cryptomarketcloud.com/dev-cmc/';
