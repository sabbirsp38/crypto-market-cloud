    ...
    <div class="container_12">
        ...
        <div class="grid_10">
            ...
            <div class="box round first grid">
                <h2>Add Pakage</h2>
                <div class="block">               
                 <form action="dbconnect pakage.php" method="post" enctype="multipart/form-data">
                    <table class="form">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" placeholder="Enter pakage Title..." class="medium" name="name" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input type="text" placeholder="Enter Post Title..." class="medium" name="price" />
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td>
                                <label>Sell End Time</label>
                            </td>
                            <td>
                                
                                <textarea name="dec" class="tinymce"></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <label>Pakage Type</label>
                            </td>
                            <td>
                                <select name="type" style="min-width: 300px;">
