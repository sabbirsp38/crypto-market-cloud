 ...
 <ul class="section menu">
        ...
        <div class="grid_10">
            ...
            <div class="box round first grid">
                <h2>Add New sicial</h2>
                <div class="block">               
                 <form action="dbconncetsocial.php" method="post" enctype="multipart/form-data">
                    <table class="form">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" placeholder="Enter Facebook Link..." class="medium" name="fb_link" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input type="text" placeholder="Enter Twitter Link..." class="medium" name="twitter_link" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input type="text" placeholder="Enter Linkedin Link..." class="medium" name="linkedin_link" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input type="text" placeholder="Enter Medium Link..." class="medium" name="midiam_link" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input type="text" placeholder="Enter Youtube Link..." class="medium" name="youtube_link" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input type="text" placeholder="Enter Telegram Link..." class="medium" name="telegram_link" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input type="text" placeholder="Enter Instragram Link..." class="medium" name="instragram_link" />
                            </td>
                        </tr>
