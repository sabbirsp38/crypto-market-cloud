    ...
    <div class="container_12">
        ...
        <div class="grid_10">
            ...
            <div class="box round first grid">
                ...
                <div class="block">               
                 <form action="dbconncetpartner.php" method="post" enctype="multipart/form-data">
                    <table class="form">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" placeholder="Enter Company Name..." class="medium" name="name" />
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="file" name="img" data-provide="dropify" data-allowed-file-extensions="png jpg jpeg JPG PNG JEPG" data-allowed-formats="square" class="clearablefileinput" id="id_image">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" placeholder="Enter Web Address" class="medium" name="web_link" />
                            </td>
                        </tr>
