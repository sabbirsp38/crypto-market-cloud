    ...
    <div class="container_12">
        ...
        <div class="grid_10">
            ...
            <div class="box round first grid">
                <h2>Add New Post</h2>
                <div class="block">               
                 <form action="dbconnect_addpoint.php" method="post" enctype="multipart/form-data">
                    <table class="form">
                     <?php
                      $query = "select * from tbl_point_order where id=$id";
                      $post = $db->select($query);
                      $result= $post -> fetch_assoc()
                        ?>

                       <input  placeholder="Enter Post Title..." class="medium" name="f_id" value="<?php echo $result['f_id']; ?>" style="display:none"/>
                       <input  placeholder="Enter Post Title..." class="medium" name="f_name" value="<?php echo $result['name']; ?>" style="display:none"/>
 <input  placeholder="Enter Post Title..." class="medium" name="w_address" value="<?php echo $result['W_address']; ?>" style="display:none"/>
 <input  placeholder="Enter Post Title..." class="medium" name="amount" value="<?php echo $result['amount']; ?>" style="display:none"/>

                        <tr>
                            <td>
                                <label><h3>Account Holder Name: </h3></label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <label><h3>TRNASCTION ID: </h3></label>
                            </td>
                            <td>
                                <h3><?php echo $result['T_id']; ?></h3>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <label><h3>WALLET ADDRESS:</h3></label>
                            </td>
                            <td>
                                <h3><?php echo $result['W_address']; ?></h3>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <label><h3>Requested Amount:</h3></label>
                            </td>
                            <td>
                                <h3><?php echo $result['amount']; ?></h3>
                            </td>
                        </tr>
                     
                        <tr>
                            <td>
                                <label><h3>Converted Point:</h3></label>
                            </td>
                            <td>
