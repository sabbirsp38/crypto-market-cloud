    ...
    <div class="container_12">
        ...
        <div class="grid_10">
            ...
            <div class="box round first grid">
                <h2>Add New Trending Now</h2>
                <div class="block">               
                 <form action="dbconncet Trending Now.php" method="post" enctype="multipart/form-data">
                    <table class="form">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" placeholder="Enter Company Name..." class="medium" name="ico_name" />
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="file" name="logo_img" data-provide="dropify" data-allowed-file-extensions="png jpg jpeg JPG PNG JEPG" data-allowed-formats="square" class="clearablefileinput" id="id_image">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" placeholder="Enter Web Address" class="medium" name="website_link" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input type="text" placeholder="Enter Web Address" class="medium" name="company_tagline" />
                            </td>
                        </tr>
